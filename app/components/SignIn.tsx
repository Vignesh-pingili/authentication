...
const SignIn = () => {
      ...
      if(session){
        return(
                      <Card elevation={6} sx={{p:1,height:"60px",m:1}}>
 <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:4}}>
  ...
  return (
    <Box sx={{height:"100vh",backgroundColor:"#F0F4F9",display:"flex",alignItems:"center",justifyContent:"center"}}>
        <Card elevation={12}>
            <Box sx={{fontSize:"1.8rem",fontWeight:"600",textAlign:"center",pb:6,pt:2,color:"#404042"}}>
                Sign In
            </Box>
            <Divider sx={{width:"86%"}} variant="middle" />
            <Box sx={{pr:4,pl:4,pb:2}}>
                <Box sx={{pb:1,pt:4}}>
        ...
        c0.29-0.66-0.2-1.41-0.92-1.41H37c-2.21,0-4-1.79-4-4v-2c0-2.21,1.79-4,4-4h17C56.75,27,59,29.22,59,31.97z"></path></svg>
                    ...
                    <Box onClick={() => signIn('linkedin')} sx={{display:"flex",alignItems:"center", gap:1,p:0.8}}>
                        ...
                        <Typography sx={{color:"#FFF",lineHeight:"1.6rem"}}>LogIn with Linked In</Typography>
                    </Box>
                </Card>
                    ...
                    <Box onClick={() => signIn('orcid')} sx={{display:"flex",gap:1.8,p:1,alignItems:"center"}}>
                        ...
                        <Typography>LogIn with <span style={{color:"#A6A8AB"}}>ORC</span><span style={{color:"#A6CE39"}}>iD</span></Typography>
                    </Box>
                </Card>
...
// display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",border:"1px solid red"